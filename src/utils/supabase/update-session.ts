...
export async function updateSession(request: NextRequest) {
  ...
  // Si hay usuario, verificamos el tenant_id
  if (user) {
    // El tenant_id está en user.app_metadata.tenant_id (o claims si se inyectó)
    // El usuario pidió verificar en app_metadata
